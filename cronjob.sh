...
# Define paths
NETWORK_SCRIPT="/root/Network-configuration/PythonScript/Network-configuration.py"
ARP_SCRIPT="/root/Network-configuration/PythonScript/arp-pythonscript.py"
BIN_DIR="/bin"
VITE_SCRIPT="/root/Network-configuration/PythonScript/start-vite.sh"
...
crontab -l | grep -v "/bin/Network-configuration.py" | grep -v "/bin/arp-pythonscript.py" | grep -v "/bin/bash /root/Network-configuration/PythonScript/start-vite.sh" | crontab -
